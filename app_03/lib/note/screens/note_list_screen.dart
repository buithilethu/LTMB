                ...
                return NoteItem(
                  ...
                  onTap: () async {
                    await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => NoteDetailScreen(noteId: _notes[index].id!),
                      ),
                    );
                    _refreshNoteList();
                  },
                  onEdit: () async {
                    await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => NoteFormScreen(noteId: _notes[index].id),
                      ),
                    );
                    _refreshNoteList();
                  },
                  onDelete: () => _showDeleteConfirmation(_notes[index].id!),
                );
              },
            )
                : ListView.builder(

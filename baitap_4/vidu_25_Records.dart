...
/*
    Record là một kiểu dữ liệu tổng hợp (composite type) được giới thiệu trong Dart 3.0
    cho phép nhóm nhiều giá trị có kiểu khác nhau thành một đơn vị duy nhất
    Record là imutable - nghĩa là không thể thay đổi sau khi được tạo
*/

void main(){
  var r = ('first',a:2, 5, 10.5); // record

  //Định nghĩa record có 2 giá tri
